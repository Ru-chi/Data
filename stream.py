...
ACCESS_TOKEN = '1392142676234014720-9TJ4kLh2cASpzWinuYYH7Kb7HslZwy'
ACCESS_SECRET = 'lx9pkhcHOxEdRPUbIzSnqfR28n6thukQA0B95oefHBrpm'
CONSUMER_KEY = 'QLLu2rJg6PZEAV1o9a1pbDGSa'
CONSUMER_SECRET = 'ntB1QeL0LHYKoGBgIwsSf16sLvf3Zu5QDaioZF9i5Filfn3Zzf'

auth = tweepy.OAuthHandler(CONSUMER_KEY, CONSUMER_SECRET)
auth.set_access_token(ACCESS_TOKEN, ACCESS_SECRET)

#can set multiple hashtags and set whatever 
hashtag = '#covid19'
